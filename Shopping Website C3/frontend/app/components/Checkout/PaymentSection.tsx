...
export function PaymentSection({
  ...
  return (
    <div>
      ...
      <button
        disabled={isPending}
        className="w-full mt-6 px-6 py-3 flex items-center justify-center bg-gray-800 font-semibold font-inter text-white rounded transition-colors"
      >
        {isPending ? (
