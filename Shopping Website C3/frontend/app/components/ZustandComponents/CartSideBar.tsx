...
import { CheckoutItem, useCheckout } from "@/app/zustand/useCheckout";
...
export default function CartSideBar() {
  ...
  return (
    <aside
      ...
      } fixed inset-0 w-full bg-black/30 z-100 flex items-start justify-end *:font-spartan`}
    >
      <div
        ...
        <div className="w-full shadow-2xl h-[20%] border-t border-t-gray-200">
          ...
          <div className="flex items-center gap-2.5 px-6 py-4">
            <button
              ...
              className="border-[#f8d774] border w-full p-3 rounded-full"
            >
              Shop More
            </button>
            <button
              ...
              // varient="fill"
              className="bg-[#f8d774] w-full p-3 rounded-full flex items-center justify-center text-black text-s border-black"
            >
              {isPending ? (
