...
const fallbackProducts: Product[] = [
  {
    ...
    image2: "https://framerusercontent.com/images/lvt1WlyrgirePb8z3BSlF9OY.jpg",
    price: 59.0,
    originalPrice: 79.0,
  },
  {
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
            <div>
              <div className="inline-flex items-center gap-2 bg-white border border-black rounded-full px-4 py-2 mb-6">
                <Star size={16} className="fill-black" />
                <span className="text-sm font-medium text-black">
                  <ScrollingText text="MEN" className="text-lg font-semibold" />
                </span>
              </div>
              ...
              <p className="text-sm text-black/70 mb-6">
                {firstCategory
                  ? `Showing products from category: ${firstCategory.name ?? activeCategory}`
                  : "Loading first category..."}
              </p>
