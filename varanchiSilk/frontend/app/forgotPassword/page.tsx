...
import ResetOtpModal from "@/components/ui/resetOtpModal";
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              focus:ring-2 focus:ring-[#053628] outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isPending}
            className={`w-full bg-[#053628] hover:bg-[#053628] text-white font-semibold py-3 rounded-xl shadow-md transition
