...
const ProductsPage = () => {
  ...
  const [maxPrice, setMaxPrice] = useState<number>(150000); // slider max filter
  ...
  const {
    ...
    queryFn: () => getFetcher(`/api/v1/products/category`),
  });
  ...
  const {
    ...
    queryFn: () => getFetcher(buildProductsUrl()),
  });
    ...
    return (
      <div className="border-b border-gray-200 py-4">
        ...
        >
          ...
          <ChevronDown
            className={`w-4 h-4 text-gray-800 transition-transform ${isExpanded ? "rotate-180" : ""
              }`}
          />
        </button>
          ...
          <aside className="w-full lg:w-1/4">
            ...
            <div className="border-b border-gray-200 py-4">
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform text-gray-900 ${expandedFilters["price"] ? "rotate-180" : ""
                    }`}
                />
              </button>
              ...
              <div className="flex justify-end mb-6">
                <div ref={dropdownRef} className="relative w-56">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform text-gray-800 ${showSortMenu ? "rotate-180" : ""
                        }`}
                    />
                  </button>
