...
import { editorJsonToHtml } from "../utils/editorParser";
  ...
  await doTransition(async (client) => {
    const { rowCount, rows } = await client.query(
      `INSERT INTO products 
        (sku_id, name, description, description_json, category_id, price, compare_at_price, available_quantity, meta_title, meta_description, status, tags, slug, sub_category_id, product_for)
       VALUES
