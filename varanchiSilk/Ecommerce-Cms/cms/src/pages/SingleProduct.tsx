...
export default function SingleProduct() {
  ...
  const [_, setSubCategoryList] = useState<ISubCategory[]>([]);
  ...
  const handleFormSubmit = (formData: FormData) => {
    ...
    // payload["description"] = productDescription.current;
    // payload["description"] = JSON.stringify(editorData.current);
            ...
            <div className="sticky top-0 h-fit space-y-7">
              <Section>
                ...
                <LabelTextArea
                  name="tags"
                  label="Tags"
                  placeholder="5kg Atta,50 kg Maida"
                  defaultValue={productData[0]?.tags ?? ""}
                />
              </Section>
