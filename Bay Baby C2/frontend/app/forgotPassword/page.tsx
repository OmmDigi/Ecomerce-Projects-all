...
import ResetOtpModal from "@/components/ui/account/resetOtpModal";
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              focus:ring-2 focus:ring-[#e3694b] outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full bg-[#e3694b] hover:bg-[#e3694b] text-white font-semibold py-3 rounded-xl shadow-md transition
