  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <nav className="text-sm mt-5 md:mt-0 text-gray-500">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1">
              ...
              {sortedProducts?.map((product: any) => (
                <div key={product.id} className="group cursor-pointer">
                  <div className="relative aspect-[4/5] mb-3 overflow-hidden bg-gray-100">
                    ...
                    {product.isNew && (
                      <span className="absolute top-3 left-3 bg-[#000000] text-white text-xs font-medium px-3 py-3 rounded-full z-10">
                        New!
                      </span>
                    )}
                    <Link href={`/product/${product?.slug}`}>
                      ...
                      />
                      <button className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0  group-hover:opacity-100 bg-[#000000] hover:bg-gray-800 text-white text-sm font-bold rounded px-4 py-2 transition-all duration-800 group-hover:translate-y-0 translate-y-3 border-dotted border-2 w-[90%]">
                        Select options
                      </button>
                    </Link>
                  </div>
            ...
            <div className="md:flex justify-end items-end gap-2 hidden  mb-5">
              <button
