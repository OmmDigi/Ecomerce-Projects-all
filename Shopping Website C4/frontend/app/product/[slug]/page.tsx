                  ...
                  {showLens &&
                    ...
                    (() => {
                      ...
                      return (
                        ...
                        //     top: lensPos.y - LENS_SIZE / 2,
                        //     left: lensPos.x - LENS_SIZE / 2,
                        //     maskImage: `url(${encodeURI(mainImage)})`,
                        ...
                        // />
                        <div
                          className="absolute rounded-full border-2 border-gray-300 bg-white overflow-hidden pointer-events-none shadow-2xl"
                          style={{
                            width: LENS_SIZE,
                            height: LENS_SIZE,
                            top: lensPos.y - LENS_SIZE / 2,
                        ...
                        >
                          <img
                            src={mainImage ? encodeURI(mainImage) : ""}
                            alt=""
                            className="absolute"
                            style={{
                              width: "100%",
